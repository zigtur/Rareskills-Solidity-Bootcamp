...
contract BaseSetup is Test {
    ...
    function setUp() public virtual {
        ...
        vm.prank(owner);
        myContract1 = new MyOwnNFTCollection("ZigNFT", "ZGN", 10, merkleRoot1);
        ...
        vm.prank(owner);
        myContract2 = new MyOwnNFTCollection("ZigNFTPresale", "ZNP", 1000, merkleRoot2);
    }
}
...
contract MyERC721Test is BaseSetup {
    ...
    function testMint() public {
        ...
        myContract1.selfMint{value: _mintPrice}(5);
        console.log("presaleUser1 address : %s", presaleUser1);

        vm.expectRevert();
        myContract1.ownerOf(4);

        console.log("Owner of NFT 5 is ", myContract1.ownerOf(5));
        console.log("NFT 5 URI is : ", myContract1.tokenURI(5));
    }
    ...
    function testContract1PresaleMint() public {
        ...
        vm.prank(user1);
        vm.expectRevert();
        myContract1.presaleMint(3, proof);

        vm.prank(presaleUser1);
        vm.deal(presaleUser1, 1 ether);
        myContract1.presaleMint{value: discountPrice}(3, proof);

        console.log("Presale mint : NFT 3 owner is ", myContract1.ownerOf(3));
    ...
    function testContract2PresaleMint() public {
        ...
        vm.prank(presaleUser1);
        vm.deal(presaleUser1, 1 ether);
        myContract2.presaleMint{value: discountPrice}(501, proof);
        console.log("Presale mint : NFT 501 owner is ", myContract2.ownerOf(501));
    }
}
